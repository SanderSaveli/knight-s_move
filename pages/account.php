...
<html lang="ru">
	...
	<body>		
		<div class="all-content row">
				...
				<div class="content__profile block-backgr">
						...
						<div class="profile">
							...
							<div class="profile__score">
								<div class="profile__tracker victory">
									<div class="tracker__numb text-numb">111</div>
									<div class="tracker__title">победы</div>
								</div>
								<div class="profile__tracker defeat">
									<div class="tracker__numb text-numb">111</div>
				...
				<div class="content__game-table block-backgr">
